...
void SSD1306_begin(nrf_drv_twi_t const m_twi_master, uint8_t i2caddr, uint8_t vccstate, bool reset, uint8_t displaytype, uint8_t width, uint8_t height) {
  // Init sequence
...
void SSD1306_display(nrf_drv_twi_t const m_twi_master, uint8_t i2caddr, uint8_t *buffer, uint8_t width, uint8_t height) {
