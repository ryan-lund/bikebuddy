...
/*
  ...
  virtual_timer_start(2000000, led0_toggle);
  ...
  // Cancel the repeated timer after 5s
  nrf_delay_ms(5000);
  ...
  // Create three timers which turn on LED0, LED1, LED2 at 1, 2, and 3s
  virtual_timer_start(1000000, led0_toggle);
  virtual_timer_start(2000000, led1_toggle);
  virtual_timer_start(3000000, led2_toggle);
  
  // Create three timers which turn off LED0, LED1, LED2 at 4, 5, and 6s
